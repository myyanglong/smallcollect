...
public class BaseFoldingLayout extends ViewGroup {
	 ...
	 */
	public float bflag = 0;
	public void setFoldFactor(float foldFactor) {
		if (foldFactor != mFoldFactor) {
			Log.i("debug","setFoldFactor:" + mFoldFactor+","+foldFactor + "," + bflag);
			/*
			if(bflag == mFoldFactor){
				mFoldFactor = foldFactor;
				bflag = foldFactor;
			}
			else if(mFoldFactor > bflag && mFoldFactor < foldFactor)
			{
					mFoldFactor = 0;
					bflag = 0;
			}
